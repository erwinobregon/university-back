                ...
                .EnableSwagger(c =>
                    {
                        ...
                        Description("El proyecto de muestra es una apliación construida en .NET Framework"+
                        ...
                        "como matricula y registro de notas."
                        )
                        .TermsOfService("Terminos de servicio")
                        .Contact(x=>x.Name("Erwin Obregon").Email("erwinom8@hotmail.copm").Url("University-api.com"));
